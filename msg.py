...
class msg:
     ...
     def send(self,subject,body,filename,attachment):
        ...
        if attachment:
            ...
            part.add_header('Content-Disposition', 'attachment', attachment=('utf-8', '', attachment,filename))
            msg.attach(part)

        s.sendmail(self.sender, rcpts, msg.as_string() )
        s.close()    
